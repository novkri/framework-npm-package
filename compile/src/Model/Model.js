...
class Model {
  ...
  actionGetMetadata(microserviceName, connectionType) {
    ...
    const initializeGetMetadataRequest = new GetModelMetadataAction_1.GetModelMetadataAction(
      microserviceName,
      'getMetadata',
      this.modelName
    );
    new ModelConnection_1.ModelConnection().createConnection(
      connectionType,
  ...
  actionGetItems(
    ...
    GlobalVariables_1.GlobalVariables.tokenUST = microserviceName;
    const initializeGetItems = new GetItemsAction_1.GetItemsAction(
      microserviceName,
      this.modelName,
      userGetItems
    );
  ...
  actionGetItem(microserviceName, connectionType, id, filter, withs, orders) {
    GlobalVariables_1.GlobalVariables.tokenUST = microserviceName;
    const initializeGetItem = new GetItemsAction_1.GetItemsAction(
      microserviceName,
      this.modelName,
      'getItem'
    );
  ...
  actionUpdate(microserviceName, connectionType, actionParams) {
    GlobalVariables_1.GlobalVariables.tokenUST = microserviceName;
    const initializeActionUpdate = new CRUDAction_1.CRUDAction(
      microserviceName,
      this.modelName,
      'update',
      actionParams
  ...
  actionUpdateManyWithFilter(microserviceName, connectionType, actionParams) {
    GlobalVariables_1.GlobalVariables.tokenUST = microserviceName;
    const initializeActionUpdateManyWithFilter = new CRUDAction_1.CRUDAction(
      microserviceName,
      this.modelName,
      'updateManyRaw',
      actionParams
  ...
  actionCreate(microserviceName, connectionType, actionParams, channelParameters) {
    GlobalVariables_1.GlobalVariables.tokenUST = microserviceName;
    const initializeActionCreate = new CRUDAction_1.CRUDAction(
      microserviceName,
      this.modelName,
      'create',
      actionParams,
  ...
  actionDelete(microserviceName, connectionType, actionParams) {
    GlobalVariables_1.GlobalVariables.tokenUST = microserviceName;
    const initializeActionDelete = new CRUDAction_1.CRUDAction(
      microserviceName,
      this.modelName,
      'delete',
      actionParams
  ...
  actionDeleteManyWithFilter(microserviceName, connectionType, actionParams) {
    GlobalVariables_1.GlobalVariables.tokenUST = microserviceName;
    const initializeActionDeleteManyWithFilter = new CRUDAction_1.CRUDAction(
      microserviceName,
      this.modelName,
      'deleteManyRaw',
      actionParams
  ...
  actionCustom(microserviceName, actionName, connectionType, actionParams) {
    GlobalVariables_1.GlobalVariables.tokenUST = microserviceName;
    const initializeActionCustom = new CustomAction_1.CustomAction(
      microserviceName,
      this.modelName,
      actionName,
      actionParams
